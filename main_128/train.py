...
class Configs:
    """
    Configuration and training orchestration for 3D StyleGAN.
    Handles model initialization, checkpointing, augmentation, and training loop.
    """
    def __init__(self):
    ...
    def get_w(self, batch_size: int):
        """
        Generates style vectors w for the generator.

        If style mixing is enabled, combines two latent codes at a random crossover point.
        """
    ...
    def generate_volumes(self, batch_size: int):
        """Generates a batch of volumes using the generator and returns both volumes and style vectors."""
    ...
    def get_disc_input_noise_sigma(self, step: int) -> float:
        """
        Computes the noise sigma added to discriminator inputs.

        Decays from sigma1 to sigma3 over two stages.
        """
    ...
    def save_images(self, step, generated_volumes, real_volumes):
        """Saves a comparison image of generated and real volume slices."""
    ...
    def save_checkpoint(self, step: int):
        """Saves a training checkpoint including all models and optimizers."""
        checkpoint = {
            'step': step,
    ...
    def init(self):
        """Initializes datasets, models, optimizers, and the augmentation pipeline."""
    ...
    def step(self, idx: int):
        ...
        Updates the discriminator (with optional repeated updates), then the generator.
        Handles augmentation, adaptive statistics, and gradient penalty.
        """
